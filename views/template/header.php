    ...
    <nav class="navbar navbar-static-top">
        <div class="container">
            <div class="navbar-header">
                <a href="<?php echo base_url(); ?>site" class="navbar-brand"><i class="fa fa-home"></i></a>
            ...
            <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>site/department.html">Department</a>
                    </li>
                   
					<li>
                        <a href="<?php echo base_url(); ?>site/create.html">Settings</a>
                    </li>
                </ul>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="<?php echo base_url(); ?>dist/img/user-a.png" class="user-image" alt="User Image"/>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="<?php echo base_url(); ?>dist/img/user-a.png" class="img-circle" alt="User Image" />
                                <p>
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="<?php echo base_url(); ?>site/logout.html" class="btn btn-default btn-flat">Logout</a>
                                </div>
                            </li>
                        </ul>
                    </li>
